...
<body>
    ...
    <header class="navbar">
        <div class="logo-container">
            <img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="Logo 1" class="logo">
            <img src="<?php echo e(asset('assets/images/disdik.png')); ?>" alt="Logo 2" class="logo">
        </div>
        <nav>
            <ul>
...
<?php /**PATH C:\xampp\htdocs\project_sapras\perpus\resources\views/home.blade.php ENDPATH**/ ?>